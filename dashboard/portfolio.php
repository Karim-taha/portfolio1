              ...
              <form action="portfolio.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleInputProjectName" placeholder="Enter project name">
                  </div>
                  <div class="form-group">
                    <label for="summernote">Description</label>
                    <textarea name="description" class="form-control" id="summernote" cols="30" rows="3" placeholder="Enter description"></textarea>
                  </div>
                  <div class="form-group">
