...
if(isset($_POST['submit'])){
    ...
    move_uploaded_file($avatarTmp, "uploads/".$avatarName);
    
    $cvTmp = $_FILES['cv']['tmp_name'];
    $cvName = $_FILES['cv']['name'];
    move_uploaded_file($cvTmp, "uploads/".$cvName);

    addSettings($avatarName, $job_title, $about, $cvName, $user_id);
...
<?php require_once 'sidebar.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content-header -->
    <div class=" bg-success text-white"><?php // echo (isset($success)) ? $success : "" ; ?></div>
    <!-- Main content -->
              ...
              <form action="settings.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="job_title" class="form-control" id="jobTitile" placeholder="Enter job title">
                  </div>
                  <div class="form-group">
                    <label for="summernote">About</label>
                    <textarea name="about" class="form-control" id="summernote" cols="30" rows="3" placeholder="Talk about yourself"></textarea>
                  </div>
                  <div class="form-group">
