...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <?php if(isset($_GET['updateSettingsError'])) : ?>
            <div class="alert alert-danger">
                <?php $error = "Something is wrong, try again later.";
                echo $error;
                ?>
            </div>
        <?php endif; ?>
        <?php if(isset($_GET['updateSettingsSuccess'])) : ?>
            <div class="alert alert-success">
                <?php $error = "Settings updated successfully.";
                echo $error;
                ?>
            </div>
        <?php endif; ?>
        ...
        <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td><?php echo $setting['job_title']; ?></td>
                    <td><?php echo $setting['about']; ?></td>
                    <td><img src="uploads/<?php echo $setting['avatar']; ?>" width="100" height="100" alt="avatar"></td>
                    <td><?php echo $setting['cv']; ?></td>
                    <td><a href="updatesetting.php?setting_id=<?php echo $setting['id']; ?>" class="btn btn-warning">Update</a></td>
                  </tr>
                  <?php } ?>
                  </tbody>
                  <tfoot>
